const Cart = require('../controllers/containerCarts.js');
...
const addProductToCart = (req, res) => {
	...
	if (isNaN(idCartSelected)) return res.status(400).send({ message: 'Ingresa el ID de un carrito valido' });
...
const deleteProduct = (req, res) => {
	...
	if (isNaN(id) || isNaN(id_prod)) return res.status(400).send({ message: 'Ingresa el ID de un carrito valido' });
